...
const meta = {
  ...
  argTypes: {
    ...
    mode: selectArg(
      ...
      'Use `vertical` or `horizontal` for standard bar charts and `distribution` for segmented proportion bands.',
      'Structure',
      undefined,
      'inline-radio',
      {
    ...
    layout: selectArg(
      ['grouped', 'stacked'],
      'Finite bar layout choice for standard vertical or horizontal bars.',
      'Structure',
      { arg: 'mode', neq: 'distribution' },
      'inline-radio',
      {
